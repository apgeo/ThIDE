...
// %AppData%/ThIDE/settings.json (XDG fallback on POSIX). Mirrors the
...
public sealed record AppSettings
{
    ...
    /// <summary>Show the Welcome start page at launch when no files/workspace are restored. On by default.</summary>
    public bool ShowWelcomeOnStartup { get; init; } = true;
...
public sealed class AppSettingsService : IAppSettingsService
{
    ...
    private static string DefaultPath()
    {
        ...
        return Path.Combine(appData, "ThIDE", "settings.json");
    }
}
