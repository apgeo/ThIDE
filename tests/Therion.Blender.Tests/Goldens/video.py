...
if thide_enum(_img, "file_format", ("FFMPEG",)) is not None:
    ...
    thide("warning", "This Blender build has no FFMPEG video encoder; rendering a PNG frame sequence instead of golden-video.mp4.")
    if hasattr(_img, "media_type"):
        thide_enum(_img, "media_type", ("IMAGE",))
    _img.file_format = 'PNG'
    _img.color_mode = "RGB"
    scene.render.filepath = os.path.join(OUT_DIR, "golden-video_####")
