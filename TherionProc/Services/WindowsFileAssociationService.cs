...
// default app) is hash-protected and can't be overwritten programmatically, so this makes TherionProc
...
public sealed class WindowsFileAssociationService : IFileAssociationService
{
    ...
    private static string ProgId(string ext) => "TherionProc" + ext; // e.g. "TherionProc.th"
