...
public partial class MainWindowViewModel : ViewModelBase
{
    ...
    public MainWindowViewModel() : this(
        ...
        new ProjectToolViewModel(new ProjectDashboardViewModel(), new SurveyTreeViewModel(), new ProjectAuditViewModel(), new DataAnalyticsViewModel(), new LeadsViewModel()),
