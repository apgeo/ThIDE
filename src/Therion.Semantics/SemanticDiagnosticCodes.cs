...
public static class SemanticDiagnosticCodes
{
    ...
    /// <summary>A data row's column count doesn't match its declared reading order.</summary>
    ...
    /// <summary>A user-authored naming-convention lint was violated.</summary>
    public const string NamingConvention    = "TH_SEM_NAMING";

    // ---- project-level analysis diagnostics ----
    /// <summary>A naming collision: the same survey/map name is declared in more than one file.</summary>
    public const string DuplicateDeclaration = "TH_SEM_010";
    /// <summary>A closed loop in the centreline has a misclosure beyond tolerance.</summary>
    public const string LoopMisclosure       = "TH_SEM_011";
    /// <summary>A shot looks like a blunder/outlier (zero/over-long leg, self-loop, …).</summary>
    public const string ShotOutlier          = "TH_SEM_012";
    /// <summary>Foresight and backsight readings disagree beyond tolerance.</summary>
