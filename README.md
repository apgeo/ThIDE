...
A cross-platform desktop **workbench / IDE for [Therion](https://therion.speleo.sk/) cave-survey projects** — modern editor tooling, a cross-file semantic model, survey analytics, syntax checking / highlighting for the `.th` / `.th2` / `.thconfig` / `.xvi` file formats, Therion compile integration, and 3D view of resulted models. Download from [releases page](https://github.com/apgeo/ThIDE/releases). 
